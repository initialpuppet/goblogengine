// TODO: Share a single aetest AppEngine Context throughout all the tests to
...
// TestModifierMissing ensures the page loads when the modifier is missing.
...
// TestFuncMapMissing ensures the FuncMaps will show an error if it is not
// found.
...
// Modify sets the view data with a string field of Foo holding the value BAR
